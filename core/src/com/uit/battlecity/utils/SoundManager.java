...
public class SoundManager {
    ...
    public static final Music MOVING = Gdx.audio.newMusic(Gdx.files.internal("sfx/moving.ogg"));
    public static final Music N_MOVING = Gdx.audio.newMusic(Gdx.files.internal("sfx/n_moving.ogg"));
    ...
    public static final Sound TANK_BONUS = Gdx.audio.newSound(Gdx.files.internal("sfx/tank_bonus.ogg"));
}
