...
public class NormalTank extends Enemy {
    ...
    public NormalTank(EnemyListener listener, Direction startDir, float posX, float posY) {
        super(listener,
                Array.with(
                        new Sprite(new Texture("tanks/tank_white_normal_up_0.png")),
                        new Sprite(new Texture("tanks/tank_white_normal_up_1.png"))),
                100,
                1,
                startDir,
                posX,
                posY,
                GameConstants.TANK_SPEED_DEFAULT);
    }
}
